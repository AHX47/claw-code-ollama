...
pub const OLLAMA_DUMMY_API_KEY: &str = "ollama";
...
/// Ollama needs no real key; we accept an optional env var for parity.
...
impl OpenAiCompatConfig {
    ...
    /// Config for a local Ollama instance (`http://localhost:11434/v1`).
    /// No real API key is required – Ollama accepts any non-empty value.
    #[must_use]
